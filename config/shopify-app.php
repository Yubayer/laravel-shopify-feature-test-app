    ...
    */
    ...
    'webhooks' => [
            [
                ...
                'address' => env('SHOPIFY_WEBHOOK_1_ADDRESS', 'https://mastodon-eminent-aphid.ngrok-free.app/webhook/app-uninstalled')
            ],
            [
                'topic' => 'CARTS_UPDATE',
                'address' => 'https://mastodon-eminent-aphid.ngrok-free.app/webhook/carts-update'
            ],
            [
                'topic' => 'ORDERS_CREATE',
                'address' => 'https://mastodon-eminent-aphid.ngrok-free.app/webhook/orders-create'
            ],
            [
                'topic' => 'ORDERS_PAID',
                'address' => 'https://mastodon-eminent-aphid.ngrok-free.app/webhook/orders-paid'
            ],
        ],
